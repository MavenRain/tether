...
MUTANTS = [
    ...
    ('MEMBERS-STATE', 'store/interp.ml', b'keep (Store.smembers key store)',
     b'Result.map (fun ss -> ss, Store.empty) (Store.smembers key store)', UNIT, b'FAIL SET-MEMBERS-UNIT missing'),
    ...
    ('LUA-MEMBERS-SORT', 'print/lua.ml', b'table.sort(got,byte_less)',
     b'table.sort(got,function(a,b) return byte_less(b,a) end)', probe('all'), b'SET-MEMBERS LuaJIT member order'),
