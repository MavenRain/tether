...
and erasure of `M0Spine.tet` spend 93751 polls with the M1 String byte
prelude and the static walk spends 12, so fuel 93751 through 93762 reaches
the printer's own guard. A second gate case runs at fuel 93757 and pins
`SH-BUDGET`.
