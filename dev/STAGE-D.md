...
and erasure of `M0Spine.tet` spend 9971 polls with the M1 Set prelude
and the static walk spends 12, so fuel 9971 through 9982 reaches the
printer's own guard. A second gate case runs at fuel 9977 and pins
`SH-BUDGET`.
