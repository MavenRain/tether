...
and erasure of `M0Spine.tet` spend 29033 polls with the M1 Set store
prelude and the static walk spends 12, so fuel 29033 through 29044 reaches
the printer's own guard. A second gate case runs at fuel 29039 and pins
`SH-BUDGET`.
