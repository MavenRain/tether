...
and erasure of `M0Spine.tet` spend 60327 polls with the M1 Set bulk
prelude and the static walk spends 12, so fuel 60327 through 60338 reaches
the printer's own guard. A second gate case runs at fuel 60333 and pins
`SH-BUDGET`.
