...
and erasure of `M0Spine.tet` spend 19006 polls with the M1 Hash enumeration
prelude and the static walk spends 12, so fuel 19006 through 19017 reaches
the printer's own guard. A second gate case runs at fuel 19012 and pins
`SH-BUDGET`.
