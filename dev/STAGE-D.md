...
and erasure of `M0Spine.tet` spend 51636 polls with the M1 conditional-expiry
prelude and the static walk spends 12, so fuel 51636 through 51647 reaches
the printer's own guard. A second gate case runs at fuel 51642 and pins
`SH-BUDGET`.
