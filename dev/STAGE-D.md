...
and erasure of `M0Spine.tet` spend 2718 polls and the static walk spends
12, so fuel 2718 through 2729 reaches the printer's own guard. A second
gate case runs at fuel 2724 and pins `SH-BUDGET`.
