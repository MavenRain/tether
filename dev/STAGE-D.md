...
and erasure of `M0Spine.tet` spend 30471 polls with the M1 Set move
prelude and the static walk spends 12, so fuel 30471 through 30482 reaches
the printer's own guard. A second gate case runs at fuel 30477 and pins
`SH-BUDGET`.
