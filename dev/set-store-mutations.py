...
MUTANTS = [
    ...
    ('STORE-SECOND-SOURCE', 'store/store.ml', b'members other store', b'members key store', UNIT, b'FAIL SET-STORE-UNIT right only'),
    ...
    ('LUA-DESTINATION', 'print/lua.ml', b'[s.tag],k,key(s[2]),key(s[3])', b'[s.tag],key(s[2]),key(s[2]),key(s[3])', probe('union'), b'TWIN stored value mismatch'),
    ('LUA-SECOND-SOURCE', 'print/lua.ml', b'[s.tag],k,key(s[2]),key(s[3])', b'[s.tag],k,key(s[2]),key(s[2])', probe('union'), b'TWIN expected set'),
