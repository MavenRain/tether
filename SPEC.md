...
M1 bulk List pop slice, 2026-09-20. The driver emits the executable Wasm
...
`dev/PRELUDES.sha256`; their 195 lines are reported separately without
...
pivot insertion, atomic List moves, bulk List pops, bulk Set addition and removal,
...
profile-default, active-queue, queue-cleanup, queue-insertion, queue-transfer and queue-drain examples are implemented.
